...
## 🛠️ Featured Product Operations Labs

### 1. [SQL Integrity Lab: Fintech Data Auditing](https://github.com/JennyCloud/fintech-ops-sql-lab)
**Ops Focus:** *Product Stability & Data Accuracy*
* **The Problem:** Application-level bugs can occasionally allow invalid data (e.g., negative loan balances) into production tables, causing downstream reporting errors.
* **The Solution:** A SQL-based audit suite that identifies transactional anomalies and "orphaned" records in a lending environment.
* **Key Skill:** Demonstrates the ability to perform deep-dive data investigation—a core responsibility for an Application Support Analyst.

### 2. [PowerShell Lab: Self-Healing Application Monitor](https://github.com/JennyCloud/powershell-self-healing-monitor)
**Ops Focus:** *Infrastructure Reliability & Uptime*
* **The Problem:** Critical application services (like web listeners or payment processors) can hang or crash, leading to service interruptions.
